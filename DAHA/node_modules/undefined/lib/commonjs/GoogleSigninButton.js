...
class GoogleSigninButton extends _react.PureComponent {
  constructor() {
    super(...arguments);
  ...
  componentDidMount() {
    if (_reactNative.Platform.OS === 'android') {
      this._clickListener = _reactNative.DeviceEventEmitter.addListener('RNGoogleSigninButtonClicked', () => {
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_RNGoogleSiginButton.RNGoogleSigninButton, _extends({}, props, {
